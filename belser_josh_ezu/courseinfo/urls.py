...
from courseinfo.views import (
    ...
    InstructorList, SectionList, RegistrationList, SemesterList, StudentList, CourseList, InstructorDetail,
    SectionDetail, SemesterDetail, StudentDetail, CourseDetail, RegistrationDetail, InstructorCreate, SectionCreate, CourseCreate,
    StudentCreate, SemesterCreate, RegistrationCreate, InstructorUpdate, CourseUpdate, StudentUpdate, SemesterUpdate, RegistrationUpdate,
    SectionUpdate, RegistrationDelete, InstructorDelete, SectionDelete, StudentDelete, CourseDelete, SemesterDelete
)
